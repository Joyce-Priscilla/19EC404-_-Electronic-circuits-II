...
<img width="913" height="1280" alt="image" src="https://github.com/user-attachments/assets/df153a2e-ffcd-4dff-a9bf-39582cf35aa2" />

<img width="1252" height="590" alt="image" src="https://github.com/user-attachments/assets/f7f179ed-4e5c-4dc7-bb0b-43695238b7b8" />
...
<img width="1233" height="1280" alt="image" src="https://github.com/user-attachments/assets/e19e81bb-c4db-47a8-bd80-3edc4de661d2" />

# Graph

<img width="934" height="1280" alt="image" src="https://github.com/user-attachments/assets/dfd5d7b7-a9f3-4f65-9e13-828af8cf1688" />
...
|:----:|-------------|:----------------:|:--------------:|
| 1 | Lower cut-off frequency |f1 = 30Hz|f1' = 300Hz|
| 2 | Upper cut-off frequency |f2 = 300KHz|f2' = 300KHz|
| 3 | Bandwidth | \( BW = fh - fl = 270KHz\) | \( BW = f'h - f'l = 299.7KHz\) |
| 4 | Mid-band Gain | \( A{v(mid)} = 20.51\) | \( A'{v(mid)} = 20\) |
| 5 | Gain at half power point |Go = 19  |Go' = 17 |
