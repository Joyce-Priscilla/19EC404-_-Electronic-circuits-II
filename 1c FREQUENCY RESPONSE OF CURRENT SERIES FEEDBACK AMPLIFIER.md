...
<img width="845" height="1280" alt="image" src="https://github.com/user-attachments/assets/bb621bb1-e324-48e6-8589-b452b53a8b0e" />

<img width="1085" height="640" alt="image" src="https://github.com/user-attachments/assets/26dff258-c665-4696-be68-1aba43f2e4fe" />
...
<img width="1101" height="1280" alt="image" src="https://github.com/user-attachments/assets/ea80ec1e-3348-4586-ab45-0845c241bba8" />

# Graph

<img width="965" height="1280" alt="image" src="https://github.com/user-attachments/assets/2bc0f88b-f55e-4dd1-a713-236eafbc57ca" />
...
|:----:|-------------|:----------------:|:--------------:|
| 1 | Lower cut-off frequency |f1 = 100Hz|f1' = 30Hz|
| 2 | Upper cut-off frequency |f2 = 500KHz|f2' = 500Hz|
| 3 | Bandwidth | \( BW = fh - fl = 400KHz\) | \( BW = f'h - f'l = 470KHz\) |
| 4 | Mid-band Gain | \( A{v(mid)} = 10.31\) | \( A'{v(mid)} = 20.73\) |
| 5 | Gain at half power point |Go = 7Hz  |Go' = 20Hz  |
